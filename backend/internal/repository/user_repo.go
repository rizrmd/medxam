...
func (r *UserRepository) Update(id int, updates *models.UserUpdateRequest) (*models.User, error) {
	setParts := []string{}
	args := []interface{}{}
	argIndex := 1
...
func (r *UserRepository) List(pagination models.Pagination, search string) (*models.PaginatedResponse, error) {
