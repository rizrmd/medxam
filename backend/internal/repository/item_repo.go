...
func (r *ItemRepository) Update(id int, updates *models.ItemUpdateRequest) (*models.Item, error) {
	setParts := []string{}
	args := []interface{}{}
	argIndex := 1
...
func (r *ItemRepository) List(pagination models.Pagination, search models.ItemSearchRequest) (*models.PaginatedResponse, error) {
...
func (r *ItemRepository) GetItemQuestions(itemID int, pagination models.Pagination) (*models.PaginatedResponse, error) {
	offset := (pagination.Page - 1) * pagination.PerPage
...
func (r *ItemRepository) GetItemWithQuestions(id int) (*models.ItemWithQuestions, error) {
	...
	return &models.ItemWithQuestions{
		Item:      *item,
		Questions: questions,
	}, nil
}

func (r *ItemRepository) GetItemCategories(itemID int) ([]models.Category, error) {
