...
func NewExamRepository(db *database.DB) *ExamRepository {
...
func (r *ExamRepository) GetByCode(code string) (*models.Exam, error) {
	exam := &models.Exam{}
	query := `
		SELECT id, code, name, description, options, is_mcq, is_interview, 
			   is_random, client_id, created_at, updated_at
...
func (r *ExamRepository) Update(id int, updates *models.ExamUpdateRequest) (*models.Exam, error) {
	setParts := []string{}
	args := []interface{}{}
	argIndex := 1
...
func (r *ExamRepository) List(pagination models.Pagination, search models.ExamSearchRequest) (*models.PaginatedResponse, error) {
...
func (r *ExamRepository) GetExamItems(examID int, pagination models.Pagination) (*models.PaginatedResponse, error) {
	offset := (pagination.Page - 1) * pagination.PerPage
...
func (r *ExamRepository) AddItem(examID, itemID, order int) error {
	query := `
...
func (r *ExamRepository) RemoveItem(examID, itemID int) error {
...
func (r *ExamRepository) UpdateItemOrder(examID, itemID, order int) error {
