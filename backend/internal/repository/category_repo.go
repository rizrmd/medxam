...
func (r *CategoryRepository) Update(id int, updates *models.CategoryUpdateRequest) (*models.Category, error) {
	setParts := []string{}
	args := []interface{}{}
	argIndex := 1
...
func (r *CategoryRepository) List(pagination models.Pagination, search models.CategorySearchRequest) (*models.PaginatedResponse, error) {
...
func (r *CategoryRepository) GetCategoryQuestions(categoryID int, pagination models.Pagination) (*models.PaginatedResponse, error) {
	offset := (pagination.Page - 1) * pagination.PerPage
...
func (r *CategoryRepository) AddQuestion(categoryID, questionID int) error {
	query := `
...
func (r *CategoryRepository) RemoveQuestion(categoryID, questionID int) error {
...
func (r *CategoryRepository) AddItem(categoryID, itemID int) error {
	query := `
...
func (r *CategoryRepository) RemoveItem(categoryID, itemID int) error {
