...
func NewAttemptRepository(db *database.DB) *AttemptRepository {
...
func (r *AttemptRepository) GetByID(id int) (*models.Attempt, error) {
...
func (r *AttemptRepository) GetWithDetails(id int) (*models.AttemptWithDetails, error) {
	attemptDetails := &models.AttemptWithDetails{}
	query := `
	...
	err := row.Scan(&attemptDetails.ID, &attemptDetails.AttemptedBy, &attemptDetails.ExamID,
		...
		&attemptDetails.Taker.ID, &attemptDetails.Taker.Name, &attemptDetails.Taker.Reg,
		&attemptDetails.Taker.Email, &attemptDetails.Taker.IsVerified,
		&attemptDetails.Taker.ClientID, &attemptDetails.Taker.CreatedAt, &attemptDetails.Taker.UpdatedAt,
...
func (r *AttemptRepository) StartAttempt(attemptedBy, deliveryID int, ipAddress string) (*models.Attempt, error) {
...
func (r *AttemptRepository) FinishAttempt(id int) error {
	now := time.Now()
...
func (r *AttemptRepository) UpdateScore(id int, score float64, penalty int) error {
	query := `
		UPDATE attempts 
...
func (r *AttemptRepository) UpdateProgress(id int, progress int) error {
...
func (r *AttemptRepository) List(pagination models.Pagination, search models.AttemptSearchRequest) (*models.PaginatedResponse, error) {
...
func (r *AttemptRepository) GetAttemptsByTaker(takerID int, pagination models.Pagination) (*models.PaginatedResponse, error) {
...
func (r *AttemptRepository) GetAttemptsByDelivery(deliveryID int, pagination models.Pagination) (*models.PaginatedResponse, error) {
	search := models.AttemptSearchRequest{
		DeliveryID: deliveryID,
	}
	return r.List(pagination, search)
...
// Attempt Questions
func (r *AttemptRepository) SaveAnswer(attemptQuestion *models.AttemptQuestion) error {
...
func (r *AttemptRepository) GetAttemptAnswers(attemptID int) ([]models.AttemptQuestion, error) {
	answers := []models.AttemptQuestion{}
	query := `
...
func (r *AttemptRepository) GetResultsSummary(deliveryID int, pagination models.Pagination) (*models.PaginatedResponse, error) {
	offset := (pagination.Page - 1) * pagination.PerPage
